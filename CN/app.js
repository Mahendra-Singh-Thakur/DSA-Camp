...
topics.forEach((t) => {
    ...
    for (let item of CN.Modules[t.innerText]) {
        string += `<a href="../CN/SubTopics/${t.innerText}/${item}/index.html">
                        <div class="list-container">
                            <img class="image" src="../IMAGES/CN/logologo.jpg">
                            <li>
                                <a href="../CN/SubTopics/${t.innerText}/${item}/index.html">${item}</a>
                            </li>
                        </div>
                    </a>`;
    }
