...
let Null = "#";
let imgscr = "../IMAGES/DS/logologo.jpg";
...
topics.forEach((t) => {
    ...
    for (let item of DS.Modules[t.innerText]) {
        string += `<li id="${item}">
        <div class="content">
            <a class="thumbnail" href="../DS/SubTopics/${t.innerText}/${item}/index.html">
                <img src="${imgscr}" alt="please wait">
            </a>
            <div class="info">
                <a id="${item}" href="../DS/SubTopics/${t.innerText}/${item}/index.html">${item}</a>
            </div>
        </div>
        </li>`;
    }
...
//     let element = document.getElementById("Basics of DS");
