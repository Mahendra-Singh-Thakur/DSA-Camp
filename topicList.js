...
let COURSES = [
    ...
    ADA = {
        ...
        "Heap and Heap Sort" : ["Introduction to Heaps", "Operations on Heaps", "","d", "e"],
        "Divide and Conquer": ["a", "b", "c", "d", "e"],
        "Dynamic Programming": ["a", "b", "c", "d", "e"],
        "Greedy Algorithms": ["a", "b", "c", "d", "e"],
        "Backtracking": ["a", "b", "c", "d", "e"],
        "Graph Algorithms": ["a", "b", "c", "d", "e"],
        "Hashing": ["a", "b", "c", "d", "e"],
